...
| Automated tests | ❌ | ◐ | ✅ | ✅✅ | ✅✅ | ✅✅ | **✅✅** | **960** unit tests at v3.1.2, **1070** on `main` + a GPU self-test over every engine (808 at v3.1.1, 703 at v3.1.0) |
...
- **1070 unit tests, all passing** on `main`. 703 of those shipped in v3.1.0;
...
1070 unit tests pass on `main` (110 of them added during v3.1.3). The GPU smoke
