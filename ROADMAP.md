...
| MilkDrop | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ◐ | ◐ | Functional baseline in v3.1.2: closure compiler solves CSP (#559), HLSL warp/comp translated (99.2% stage compile across a 10,332-preset corpus, 100% on the 505-preset original set, measured by scripts/milkdrop-compile-rate.js; 89.2% of presets render a live image, measured by scripts/milkdrop-render-rate.js), 8 wave modes, repeat wrap, feedback clamp. Phase 2 quality pass scheduled |
...
| Automated tests | ❌ | ◐ | ✅ | ✅✅ | ✅✅ | ✅✅ | **✅✅** | **✅✅** | **1165** unit tests at v3.1.3 + a GPU self-test over every engine (960 at v3.1.2, 808 at v3.1.1, 703 at v3.1.0) |
...
- **1165 unit tests, all passing** on `main`. 703 of those shipped in v3.1.0;
...
1165 unit tests pass at v3.1.3 (168 added during this release). The GPU smoke
