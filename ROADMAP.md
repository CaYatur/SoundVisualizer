...
| MilkDrop | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ◐ | ◐ | Functional baseline in v3.1.2: closure compiler solves CSP (#559), HLSL warp/comp translated (97.0% stage compile on the 1,126-file original set, measured by scripts/milkdrop-compile-rate.js), 8 wave modes, repeat wrap, feedback clamp. Phase 2 quality pass scheduled |
...
| Automated tests | ❌ | ◐ | ✅ | ✅✅ | ✅✅ | ✅✅ | **✅✅** | **✅✅** | **1136** unit tests at v3.1.3 + a GPU self-test over every engine (960 at v3.1.2, 808 at v3.1.1, 703 at v3.1.0) |
...
- **1136 unit tests, all passing** on `main`. 703 of those shipped in v3.1.0;
...
1136 unit tests pass at v3.1.3 (168 added during this release). The GPU smoke
