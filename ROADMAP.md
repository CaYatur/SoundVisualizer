...
| Automated tests | ❌ | ◐ | ✅ | ✅✅ | ✅✅ | ✅✅ | **✅✅** | **977** unit tests + a GPU self-test over every engine (808 at v3.1.1, 703 at v3.1.0) |
...
- **977 unit tests, all passing** on `main`. 703 of those shipped in v3.1.0;
  105 came with v3.1.1; 163 came with v3.1.2. Formulas are checked against values derived
...
- **Verification**: 977 unit tests pass on `main`. Automated GPU smoke test verifies all 50 modes, 31 backgrounds, 40 post-fx, and zero untranslated UI strings.
