...
(function () {
  ...
  const EN = {
    ...
    'Tempo (BPM)': 'Tempo (BPM)',
    'Yakalama': 'Snapping',
    'Sürüklerken Alt tuşu yakalamayı geçici olarak kapatır. Tekerlek kaydırır, Ctrl+tekerlek yakınlaştırır.': 'Hold Alt while dragging to suspend snapping. The wheel scrolls; Ctrl+wheel zooms.',
    'Cetvel': 'Ruler',
    ...
    '⏹ Çizelge · Durdur ve Başa Dön': '⏹ Timeline · Stop and Return to Start',
    ...
    'Bu sistemde sistem sesini veren bir aygıt bulunamadı.': 'No device on this system provides the audio being played.',
