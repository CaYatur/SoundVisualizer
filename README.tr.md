...
[![Test](https://img.shields.io/badge/test-1347%20geçiyor-2ea043.svg)](#testler)
...
- **HLSL warp ve composite shader'ları GLSL'e çevrilip GPU'da koşuyor.** Gerçek bir WebGL2
  ...
  pikselleri okuyor — derlenen bir shader siyah da çizebilir: **%95,7'si canlı görüntü üretiyor.**
...
**1347 birim testi, hepsi geçiyor.** Satır çalıştırmak için değil, cevap denetlemek için yazıldılar:
