...
[![Tests](https://img.shields.io/badge/tests-977%20passing-2ea043.svg)](#tests)
...
**977 unit tests, all passing.** They are written to check answers, not to exercise lines:
