...
[![Tests](https://img.shields.io/badge/tests-1534%20passing-2ea043.svg)](#tests)
...
**1534 unit tests, all passing.** They are written to check answers, not to exercise lines:
