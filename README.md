...
[![Tests](https://img.shields.io/badge/tests-1403%20passing-2ea043.svg)](#tests)
...
- **The HLSL warp and composite shaders are translated to GLSL and run on the GPU.** Measured in a
  ...
  because a shader that compiles can still draw black: **96.1% produce a live image.** Both
...
**1403 unit tests, all passing.** They are written to check answers, not to exercise lines:
