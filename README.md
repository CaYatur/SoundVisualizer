...
[![Tests](https://img.shields.io/badge/tests-929%20passing-2ea043.svg)](#tests)
...
**929 unit tests, all passing.** They are written to check answers, not to exercise lines:
