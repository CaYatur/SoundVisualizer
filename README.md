...
[![Tests](https://img.shields.io/badge/tests-1441%20passing-2ea043.svg)](#tests)
...
**1441 unit tests, all passing.** They are written to check answers, not to exercise lines:
