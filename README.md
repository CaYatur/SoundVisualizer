...
[![Tests](https://img.shields.io/badge/tests-2197%20passing-2ea043.svg)](#tests)
...
**2197 unit tests, all passing.** They are written to check answers, not to exercise lines:
