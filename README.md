...
[![Tests](https://img.shields.io/badge/tests-2196%20passing-2ea043.svg)](#tests)
...
**2196 unit tests, all passing.** They are written to check answers, not to exercise lines:
